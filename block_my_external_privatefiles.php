...
class block_my_external_privatefiles extends block_list {
	...
	function get_content() {
		...
		$this->content->items= (isguestuser($USER->id) or empty($USER->id) or $USER->id ==0)? array(): my_external_private_files_utils::print_block_content();
		$this->content->icons[] = '';
		$this->content->footer = '';
		return $this->content;
	}
	...
	function applicable_formats() {
        return array('all'=>true,'course-view'=>false,'mod'=>false,'site'=>true ,'my' => false,'tag'=>false);
    }
